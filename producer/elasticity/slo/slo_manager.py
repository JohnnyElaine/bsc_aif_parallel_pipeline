...
class SloManager:
    ...
    def __init__(self,
        ...
        self._avg_global_processing_time_slo = AvgGlobalProcessingTimeSlo(request_handler, task_generator, tolerance=avg_global_processing_t_tolerance)
        self._avg_worker_processing_time_slo = AvgWorkerProcessingTimeSlo(request_handler, task_generator, tolerance=avg_worker_processing_t_tolerance)
