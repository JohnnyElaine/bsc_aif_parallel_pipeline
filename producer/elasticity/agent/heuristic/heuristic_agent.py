...
class HeuristicAgent(ElasticityAgent):
    ...
    def _select_action(self) -> tuple[ActionType, bool]:
        ...
        return ActionType.DO_NOTHING, True # We're at maximum quality already or unable to decrease further
    ...
    def _is_oscillating(self, window_size=OSCILLATION_WINDOW_SIZE) -> bool:
        ...
        kinds = [(True if a in HeuristicAgent.INCREASE_ACTIONS else False) for a in recent_action]
