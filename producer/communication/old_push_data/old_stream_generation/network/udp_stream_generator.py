...
from producer.communication.old_push_data.old_stream_generation.network.network_stream_generator import NetworkStreamGenerator
...
class UDPStreamGenerator(NetworkStreamGenerator):
    ...
    def _chunk_data(self, data: bytes) :
        """Split old_push_data into chunks of size MAX_UDP_PACKET_SIZE."""
