...
from aif_edge_worker.computation.image_processing.image_processor.yolo.yolo_image_processor import YOLOImageProcessor
...
class DetectionYOLOImageProcessor(YOLOImageProcessor):
    def __init__(self, computation_workload: ComputationWorkload, model_loading_mode: LoadingMode, model_paths: dict):
        super().__init__(computation_workload, model_loading_mode, model_paths)
